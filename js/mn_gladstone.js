$(document).ready(function(){
	...
	console.log ("hello from mother nature gladstone");
...
function refreshData()
{
	...
	$.get("php/get/getPM10GladVal.php", function(data, status){
		let pm10 = data;
		let resprate = 99;
		let rr_attr = "10ms";
	...
	$.get("php/get/getGladstoneAirWaste.php", function(data, status){
	...
	$.get("php/get/getGladstoneLandWaste.php", function(data, status){
	...
	$.get("php/get/getGladstoneWaterWaste.php", function(data, status){
	...
	$.get("php/get/getGladstoneTransfer.php", function(data, status){
