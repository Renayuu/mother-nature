$(document).ready(function(){
	...
	console.log ("hello from mother nature mount isa");
...
function refreshData()
{
	...
	$.get("php/get/getPM10MtIsaVal.php", function(data, status){
		let pm10 = data;
		let resprate = 99;
		let rr_attr = "10ms";
	...
	$.get("php/get/getMtIsaAirWaste.php", function(data, status){
	...
	$.get("php/get/getMtIsaLandWaste.php", function(data, status){
	...
	$.get("php/get/getMtIsaWaterWaste.php", function(data, status){
	...
	$.get("php/get/getMtIsaTransfer.php", function(data, status){
